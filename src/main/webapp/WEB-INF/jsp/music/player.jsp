...
<c:set var="musicMenu" scope="request" value="active"></c:set>
<!DOCTYPE html>
<!--
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title" id="mytitle">${musics[0].musicName}</h3><br>
                <hr>
              ...
              <div class="box-body">
                <table class="table table-bordered">
                  ...
                  <tr id="inner_div">
                    ...
                    <td class="musicname">${music.musicPath}</td>
                  </tr>
                  </c:forEach>
                </table>
              </div>
              ...
              <div class="box-footer clearfix">
                <ul class="pagination pagination-sm no-margin pull-right">
                  <li><a href="${base}/music/player.do?prev=1&page=${beginlast}">&laquo;</a></li>
                  <c:forEach begin="${begin}" end="${pages}" var="i">
                  <li><a href="${base}/music/player.do?page=${i}">${i}</a></li>
                  </c:forEach>
                  <li><a href="${base}/music/player.do?next=1&page=${pageslast}">&raquo;</a></li>
                </ul>
              </div>
            </div>
            <!-- /.box -->
