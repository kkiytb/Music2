...
<c:set var="userAdd" scope="request" value="active"></c:set>
<!DOCTYPE html>
<!--
                ...
                method="post" action="${base}/user/save.do">
                  ...
                  <span style="color: red; text-align: center;">${error}</span>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="password" class="form-control" id="inputConfirm" placeholder="请再次确认密码" name="confirm">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputEmail" placeholder="请输入邮箱" name="email">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputMobile" placeholder="请输入手机号码" name="mobile">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <div class="checkbox">
                          ...
                          <label>
                            <input type="checkbox" name="roles" value="2"> VIP
                          </label>
                          <label>
                            <input type="checkbox" name="roles" value="3"> 普通用户
                          </label>
                        </div>
                      </div>
                    </div>
